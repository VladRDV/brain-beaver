// <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools https://www.svgrepo.com/collection/mobile-app-essentials-icons/ -->
import getCurrentThemeColor, {
	T_ColorName,
} from "@/shared/functions/getCurrentThemeColor";
import { useMemo } from "react";

interface I_BurgerSVGProps {
	colorName?: T_ColorName;
	width: string;
	height: string;
}

export default function ThemedBurgerSVG({
	colorName = "primary1",
	width,
	height,
}: I_BurgerSVGProps) {
	const fillColor = useMemo(() => getCurrentThemeColor(colorName), []);
